...
<Playground>
  <Button theme="primary" render={props => <a href="javascript:" {...props}>Link</a>} />{' '}
  <Button theme="primary" render={props => <input type="button" value="Input" {...props} />} />{' '}
  <Button theme="primary" render={props => <input type="submit" value="Submit" {...props} />} />{' '}
  <Button theme="primary" render={props => <input type="reset" value="Reset" {...props} />} />
</Playground>
